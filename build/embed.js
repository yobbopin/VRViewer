...
module.exports={
  "_args": [
    [
      ...
      "D:\\Working\\VR TerraPlatform\\vrview-master\\vrview-master"
    ]
  ],
  ...
  "_spec": "0.9.35",
  "_where": "D:\\Working\\VR TerraPlatform\\vrview-master\\vrview-master",
  "authors": [
...
function onRenderLoad(event) {
  if (event.videoElement) {
    ...
    if (Util.isMobile()) {
      ...
      console.log(event.videoElement);
      // event.videoElement.play();
      console.log("-----",event.videoElement.play);
      event.videoElement.play().then(_=>{console.log("res:",_)}).catch(err=>{console.log("err:",err)});
    }

    // var playPromise = event.videoElement.play();
